...
def main():
    ...
    ps = ArgumentParser(description="Download TGSS stamps.")
    ...
    if args.name is None:
        args.name = "J{:.2f}{:+.2f}_tgss".format(coords[0], coords[1])
        print("Setting name to {}".format(args.name))

    postage_stamps.TGSS(coords[0], coords[1], args.fov, args.directory, args.name,
